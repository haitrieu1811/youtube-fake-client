...
import { ListPlus, PenSquare, PlaySquare, PlusSquare, UserCircle, Youtube } from 'lucide-react'
...
const MainHeader = () => {
  ...
  return (
    <header className='bg-background border-b border-b-border h-14 flex items-center justify-between px-10 sticky top-0 left-0 right-0 z-[9] transition-all'>
      {/* Logo */}
