...
const StudioPostComments = ({ postId }: StudioVideoCommentsProps) => {
  const { comments, commentCount, getCommentsQuery, setComments } = useComments({ contentId: postId })
  return (
    <Fragment>
      {/* Comments */}
...
export default StudioPostComments
