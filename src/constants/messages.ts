...
export const ACCOUNT_MESSAGES = {
  ...
  USERNAME_LENGTH_IS_INVALID: 'Tên người dùng phải có độ dài từ 6 đến 32 ký tự',
  USERNAME_ALREADY_EXIST: 'Tên người dùng đã tồn tại',
  CHANNEL_NAME_LENGTH_IS_INVALID: 'Tên kênh phải có độ dài từ 6 đến 32 ký tự',
  CHANNEL_NAME_ALREADY_EXIST: 'Tên kênh đã tồn tại',
  BIO_LENGTH_IS_INVALID: 'Thông tin mô tả phải dài từ 1 đến 1000 ký tự',
...
export const VIDEO_MESSAGES = {
  ...
  VIDEO_CATEGORY_ID_IS_REQUIRED: 'Danh mục video là bắt buộc',
  VIDEO_CATEGORY_ID_INVALID: 'Danh mục video không hợp lệ',
  ...
  AUDIENCE_IS_REQUIRED: 'Tùy chọn người xem là bắt buộc',
